...
export default function KeywordRank() {
  ...
  return (
    <div className="flex h-full flex-col items-center justify-start gap-8 lg:w-1/2">
      <div className="h-14">
      ...
      <section className="relative w-full">
        ...
        {/* //! 교육정보 최다검색 키워드 Top5 */}
        <div className=" col-center rounded-2xl bg-main_color/5 p-8 shadow-md lg:h-[600px]">
          {isLoading ? (
            <RankLoading />
          ) : isError ? (
            <RankServerError />
